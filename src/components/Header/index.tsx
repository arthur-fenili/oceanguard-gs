...
export default function Header() {
    return (
        <header className="flex flex-row pb-10">
            <div id="container" className="flex flex-row items-center w-full border-b border-gray-200 shadow-md bg-white">
                ...
                <div className="ml-10">
                    <nav>
                        <ul className="flex flex-row space-x-6">
                            ...
                            <li className="hover:text-blue-500 text-xl text-black"><Link href="/newsletter">NEWSLETTER</Link></li>
                        </ul>
                    </nav>
                </div>
                <div className="flex space-x-5 ml-auto mr-5">
                    ...
                    <p className="hover:text-blue-500 text-xl p-2 text-black"><Link href="/register">REGISTER</Link></p>
                    <p className="hover:text-blue-500 text-xl p-2 text-black"><Link href="/login">LOGIN</Link></p>
                </div>
            </div>
        </header>
    );
