...
export default function GroupMemberCard(props: MemberCardProps) {
    return (
        <div className="flex flex-col items-center justify-center p-7 m-3 hover:bg-blue-800 rounded-md hover:translate-y-2 transition-all duration-300 ease-in-out">
            <div className='pb-5'>
